...
- Placing a spot cooler "inside the soundproof room" is absolutely unacceptable.
- Leave the main unit "outside" and pull "only the cold air" inside with a duct.
- Fill the gaps with putty and run the exhaust ventilation fan to maintain the air pressure balance.
