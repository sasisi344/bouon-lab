---
name: BouonLab Content Rewrite Expert
description: Strategic rules and workflows for auditing and rewriting legacy articles to maximize CTR, LTV, and technical accuracy.
---

# Project Skill: Content Rewrite Expert

## 📑 Quick Index

AuditWorkflow TargetSelection SCDataAnalysis CTR3%Rule PageBundleMigration LegacyAudit TechnicalUpdate ProductSpecObsolescence MarketingFramework QUEST BEAF PASONA LTVMax QOLValue VisualUpgrade Infographics EyeCatch InternalLinkOptimization MappingDB VerificationChecklist

---

## 🚀 1. Strategic Audit Workflow

Follow this sequence to identify and prioritize articles for rewriting.
...
## 🔍 2. Core Optimization Elements

### A. CTR & Search Intent Alignment

- **Title Overhaul**: If CTR is < 3%, the title is missing the user's primary "Search Pain".
- **Keyword Placement**: Force the **Main Keyword** to the beginning (left side).
- **Enticement**: Add "Pro Insights," "ROI Analysis," or "Real-world Experience" hooks.
...
### C. LTV & QOL Logic Injection

- **Target Categories**: `防音室` and `防音賃貸`.
- **Transformation**: Shift the focus from "Features" (What it is) to "Future QOL" (How your life changes).
- **Frameworks**:
  - Use **QUEST** for the narrative journey.
...
### A. Rich Visual Content (Post-2026 Standards)

- **Infographics**: For complex concepts (Dr-value, Mass Law, Soundproofing physics), generate infographics using the `visual-content-designer` skill. Use **Japanese text** for annotations.
- **Eye-Catchers**: Place context-relevant images periodically to maintain reading rhythm. Avoid text overlays on eye-catchers.
...
## 🏆 4. Rewrite Quality Checklist (Final Validator)
