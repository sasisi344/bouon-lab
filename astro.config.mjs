...
export default defineConfig({
  ...
  redirects: {
    ...
    // ── GSC 404一覧1000件の全件監査で検出（2026-09-05）───────────────────────
    //     Phase 1〜3・7/2監査でも拾いきれなかった「knowledge/use-case/solutions/company/column」が
    //     トップレベルカテゴリだった世代の旧URL55件＋/posts/未登録12件。
    //     既存記事と完全一致するslugはそのまま転送、統合先が明確な場合は最類似記事へ、
    //     不明な場合は7/2監査と同じ方式でカテゴリindexへ安全側フォールバック
    '/posts/soundproof-room-loan-guide/':                                    '/ja/money/soundproof-room-loan-guide/',
    '/posts/free-cardboard-soundproof-tech/':                                '/ja/diy/free-cardboard-soundproof-tech/',
    '/posts/danbotchi-diy-blueprints/':                                      '/ja/diy/danbotchi-diy-blueprints/',
    '/posts/diy-led-acoustic-panels/':                                       '/ja/diy/diy-led-acoustic-panels/',
    '/posts/renter-parent-house-soundproofing/':                             '/ja/diy/renter-parent-house-soundproofing/',
    '/posts/japanese-instrument-soundproof/':                                '/ja/soundproof-room/',
    '/posts/diy-limitation-low-frequency-noise/':                            '/ja/diy/',
    '/posts/electronic-drum-vibration/':                                     '/ja/knowledge/',
    '/posts/electronic-piano-vibration-solution/':                           '/ja/knowledge/',
    ...
    '/ja/solutions/soundproof-room-effectiveness/':                          '/ja/soundproof-room/',
    '/ja/solutions/chiba-soundproof-rental-guide/':                          '/ja/local/chiba-soundproof-rental-guide/',
    '/ja/use-case/remote-work-noise-solution-guide/':                        '/ja/soundproof-rental/remote-work-family-harmony-soundproof/',
    '/ja/knowledge/diy-led-acoustic-panels/':                                '/ja/diy/diy-led-acoustic-panels/',
    '/ja/solutions/soundproof-room-rental-lease/':                           '/ja/money/soundproof-room-rental-lease/',
    '/ja/solutions/100yen-gap-tape-door-soundproofing/':                     '/ja/diy/',
    '/ja/solutions/owner-renovation-shibuya-shinjuku-vtuber-strategy/':      '/ja/soundproof-rental/owner-renovation-shibuya-shinjuku-vtuber-strategy/',
    '/ja/use-case/wooden-apartment-soundproof-guide/':                       '/ja/diy/wooden-apartment-soundproof-guide/',
    '/ja/use-case/streaming-mic-soundproof-guide/':                          '/ja/creator/streaming-mic-noise-room/',
    '/ja/knowledge/japan-bouonproof-marketnextasia/':                        '/ja/business/japan-bouonproof-marketnextasia/',
    '/ja/use-case/trumpet-soundproof-room/':                                 '/ja/soundproof-room/',
    ...
    '/ja/solutions/soundproof-subsidy-zero-cost/':                           '/ja/money/',
    '/ja/solutions/acoustic-panel-placement/':                               '/ja/diy/bass-trap-installation-guide/',
    '/ja/solutions/budget-soundproof-booth-comparison/':                     '/ja/soundproof-room/budget-soundproof-booth-comparison/',
    '/ja/solutions/streamer-soundproof-room-comprehensive-guide/':           '/ja/creator/streamer-soundproof-room-comprehensive-guide/',
    '/ja/solutions/bouon-rental-market-guide/':                              '/ja/soundproof-rental/bouon-rental-market-guide/',
    '/ja/use-case/asmr-silence-ventilation/':                                '/ja/creator/',
    '/ja/solutions/office-sound-masking-security/':                          '/ja/knowledge/',
    '/ja/solutions/bourentakl-streamer-settingsetubi/':                      '/ja/creator/bourentakl-streamer-settingsetubi/',
    '/ja/solutions/absorption-vs-soundproofing-materials/':                  '/ja/knowledge/absorption-vs-soundproofing-materials/',
    '/ja/solutions/soundproof-window-subsidy-2025-guide/':                   '/ja/money/soundproof-window-subsidy-2025-guide/',
    '/ja/solutions/kawai-nasal-soundproof-room-guide/':                      '/ja/soundproof-room/kawai-nasal-soundproof-room-guide/',
    '/ja/use-case/asmr-proofroom-guide/':                                    '/ja/creator/',
    ...
    '/ja/use-case/asmr-vtuber-booth-guide/':                                 '/ja/creator/asmr-vtuber-booth-guide/',
    '/ja/solutions/free-cardboard-soundproof-tech/':                         '/ja/diy/free-cardboard-soundproof-tech/',
    '/ja/solutions/soundproof-room-effectiveness/soundproof-room-mechanism': '/ja/knowledge/d-value-truth-and-myths/',
    '/ja/solutions/soundproof-room-rental-cost/':                            '/ja/money/soundproof-room-rental-cost/',
    '/ja/solutions/bouonroom-tettei-kaisetsu/':                              '/ja/soundproof-room/bouon-osusume-hikaku/',
    '/ja/use-case/rental-game-soundproof-booth-3man/':                       '/ja/soundproof-rental/',
    '/ja/solutions/diy-vocal-soundproof-mask/':                              '/ja/diy/diy-vocal-soundproof-mask/',
    '/ja/use-case/streaming-room-layout-examples/':                          '/ja/creator/streaming-room-layout-guide/',
